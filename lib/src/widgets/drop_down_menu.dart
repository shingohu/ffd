...
class MKDropDownMenu<T extends MKDropDownMenuController> extends StatefulWidget {
  MKDropDownMenu({
...
class _MKDropDownMenuState extends State<MKDropDownMenu> {
  ...
  _buildOverlay() {
    RenderBox? renderBox = _headerKey.currentContext?.findRenderObject() as RenderBox?;
    if (renderBox == null) {
      return;
    }
  ...
  Widget build(BuildContext context) {
    var child = GestureDetector(
      ...
      child: Container(
        key: _headerKey,
        child: widget.headerBuilder?.call(_controller.menuIsShowing),
      ),
    );
    if (Platform.isIOS) {
      return child;
